...
<%--<form id="conditionFormId" action="${pageContext.request.contextPath}/staff/staffAction_findAll" method="post">--%>
	<table width="88%" border="0" style="margin: 20px;" >
	  <tr>
	    <td width="80px">部门：</td>
	    <td width="200px">
	    	<%--<s:form action="queryByDep" method="POST" id="formDep">--%>
				<%--<s:select name="staff.crmPost.crmDepartment.depId" list="#session.crmDepartments"--%>
	    ...
	    <td width="80px">姓名：</td>
		<s:form action="queryByStaffName" method="POST">
			<td width="200px" >
				<s:textfield name="staff.staffName" size="12" />
			</td>
...
<table width="100%" border="1" >
	<tr class="henglan" style="font-weight:bold;">
	 ...
	 <s:if test="#session.staffs != null">
		<s:iterator var="staff" value="#session.staffs" status="staffStatus">
			<tr class="<s:property value="%{#staffStatus.odd ? 'tabtd2' : 'tabtd1'}"/> ">
			...
			<td align="center"><s:property value="#staff.crmPost.crmDepartment.depName"/></td>
			<td align="center"><s:property value="#staff.crmPost.postName"/></td>
			<td width="7%" align="center">
				<s:url var="sid" value="queryBySid.action">
					<s:param name="staff.staffId"><s:property value="#staff.staffId"/> </s:param>
				</s:url>
				<s:a href="%{sid}"><img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img" /></s:a>
			</td>
			</tr>
		</s:iterator>
	 </s:if>
