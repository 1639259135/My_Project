...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="${pageContext.request.contextPath}/cost/add" method="post" class="main_form">
                ...
                <div class="input_info fee_type">
                    <input type="radio" name="costType" value="0" id="monthly" onclick="feeTypeChange(1);" />
                    <label for="monthly">包月</label>
                    <input type="radio" name="costType" value="1" checked="checked" id="package" onclick="feeTypeChange(2);" />
                    <label for="package">套餐</label>
                    <input type="radio" name="costType" value="2" id="timeBased" onclick="feeTypeChange(3);" />
                ...
                <div class="input_info_high">
                    ...
                    <div class="validate_msg_short error_msg">100长度以内的字母、数字、汉字和下划线的组合</div>
                </div>
