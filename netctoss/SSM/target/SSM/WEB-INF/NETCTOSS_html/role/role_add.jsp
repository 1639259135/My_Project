...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="${pageContext.request.contextPath}/role/addRole" method="post" class="main_form">
                ...
                <div class="input_info_high">
                    <div class="input_info_scroll">
                        <ul>
                            <li><input type="checkbox" name="moduleInfos[0].moduled" value="1"/>管理员管理</li>
                            <li><input type="checkbox" name="moduleInfos[1].moduleId" value="2"/>角色管理</li>
                            <li><input type="checkbox" name="moduleInfos[2].moduleId" value="3"/>资费管理</li>
                            <li><input type="checkbox" name="moduleInfos[3].moduleId" value="4"/>账务账号</li>
                            <li><input type="checkbox" name="moduleInfos[4].moduleId" value="5"/>业务账号</li>
                            <li><input type="checkbox" name="moduleInfos[5].moduleId" value="6"/>账单</li>
                            <li><input type="checkbox" name="moduleInfos[6].moduleId" value="7"/>报表</li>
                        </ul>
                    </div>
                    <span class="required">*</span>
