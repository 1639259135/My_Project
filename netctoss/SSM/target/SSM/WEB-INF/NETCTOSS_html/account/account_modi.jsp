...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">  
            ...
            <form action="${pageContext.request.contextPath}/account/modiAccount" method="post" class="main_form">
                    <!--必填项-->
                    <div class="text_info clearfix"><span>账务账号ID：</span></div>
                    <div class="input_info">
                        <input type="text" name="accountId" value="${accountById.accountId}" readonly class="readonly" />
                    </div>

                    <div class="text_info clearfix"><span>姓名：</span></div>
                    <div class="input_info">
                        <input type="text" name="realName" value="${accountById.realName}" />
                    ...
                    <div class="input_info">
                        <input type="text" name="idcardNo" value="${accountById.idcardNo}" readonly class="readonly" />
                    </div>

                    <div class="text_info clearfix"><span>登录账号：</span></div>
                    <div class="input_info">
                        <input type="text" name="loginName" value="${accountById.loginName}" readonly class="readonly"  />
                        <%--<!--                --%>
                    ...
                    <div class="input_info">
                        <input type="text" name="telephone" value="${accountById.telephone}" class="width200"/>
                        <span class="required">*</span>
                    ...
                    <div class="input_info">
                        <input type="text" name="recommenderIdcard" value="${accountById.recommenderIdcard}"/>
                    ...
                    <div class="input_info">
                        <input type="text" name="email" value="${accountById.email}" class="width200"/>
                    ...
                    <div class="input_info fee_type">
                        <input type="radio" name="gender" value="0" checked="checked" id="female" onclick="feeTypeChange(1);" />
                        <label for="female">女</label>
                        <input type="radio" name="gender" value="1" id="male" onclick="feeTypeChange(2);" />
                        <label for="male">男</label>
                    </div>

                    <div class="text_info clearfix"><span>通信地址：</span></div>
                    <div class="input_info">
                        <input type="text" name="emailaddress" value="${accountById.emailaddress}" class="width350"/>
                        <div class="validate_msg_tiny">50长度以内</div>
                    </div>

                    <div class="text_info clearfix"><span>邮编：</span></div>
                    <div class="input_info">
                        <input type="text" name="zipcode" value="${accountById.zipcode}"/>
                        <div class="validate_msg_long">6位数字</div>
                    </div>

                    <div class="text_info clearfix"><span>QQ：</span></div>
                    <div class="input_info">
                        <input type="text" name="qq" value="${accountById.qq}"/>
                        <div class="validate_msg_long">5到13位数字</div>
                    </div>                
                    <!--操作按钮-->
                    <div class="button_info clearfix">
                        <input type="submit" value="保存" class="btn_save" onclick="showResult();" />
                        <input type="button" value="取消" class="btn_save" onclick="location.href='${pageContext.request.contextPath}/account/showAccount?pageCode=1';" />
                    </div>
                </form>  
        </div>
        <!--主要区域结束-->
