...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="${pageContext.request.contextPath}/admin/modiAdmin?adminId=${adminById.adminId}" method="post" class="main_form">
                    <div class="text_info clearfix"><span>姓名：</span></div>
                    <div class="input_info">
                        <input type="text" name="name" value="${adminById.name}" />
                        <span class="required">*</span>
                        <div class="validate_msg_long error_msg">20长度以内的汉字、字母、数字的组合</div>
                    </div>

                    <div class="text_info clearfix"><span>管理员账号：</span></div>
                    <div class="input_info"><input type="text" name="adminCode" readonly="readonly" class="readonly" value="${adminById.adminCode}"  /></div>

                    <div class="text_info clearfix"><span>电话：</span></div>
                    <div class="input_info">
                        <input type="text" name="telephone" value="${adminById.telephone}"  />
                        <span class="required">*</span>
                    ...
                    <div class="input_info">
                        <input type="text" class="width200" name="email" value="${adminById.email}"/>
                        <span class="required">*</span>
